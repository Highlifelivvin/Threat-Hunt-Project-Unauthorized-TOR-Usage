...
- **Event:** The user "edr1" downloaded a file named `tor-browser-windows-x86_64-portable-14.0.1.exe` to the Downloads folder.
...
- **File Path:** `C:\Users\edr1\Downloads\tor-browser-windows-x86_64-portable-14.0.1.exe`
